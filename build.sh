...
rm mosesacs
s3cmd -c ~/.s3cfg -P put mosesacs_${VER}_linux_i386.tar.gz s3://mosesacs/
cd ..
...
rm mosesacs
s3cmd -c ~/.s3cfg -P put mosesacs_${VER}_linux_amd64.tar.gz s3://mosesacs/
cd ..
...
rm mosesacs
s3cmd -c ~/.s3cfg -P put mosesacs_${VER}_arm.tar.gz s3://mosesacs/
cd ..
...
rm mosesacs
s3cmd -c ~/.s3cfg -P put mosesacs_${VER}_osx_amd64.tar.gz s3://mosesacs/
cd ..

GOOS=windows GOARCH=386 go build -o bin/mosesacs.exe mosesacs.go
cd bin
zip mosesacs_${VER}_win_i386.zip mosesacs.exe
rm mosesacs.exe
s3cmd -c ~/.s3cfg -P put mosesacs_${VER}_win_i386.zip s3://mosesacs/
cd ..

GOOS=windows GOARCH=amd64 go build -o bin/mosesacs.exe mosesacs.go
cd bin
zip mosesacs_${VER}_win_amd64.zip mosesacs.exe
rm mosesacs.exe
s3cmd -c ~/.s3cfg -P put mosesacs_${VER}_win_amd64.zip s3://mosesacs/
cd ..